...
def build_parser() -> argparse.ArgumentParser:
    ...
    optim.add_argument(
        ...
        type=float,
        default=None,
        help="research override for the base AdamW weight-decay coefficient",
    )
    optim.add_argument(
        "--batch-size",
        type=positive_int,
...
def validate_args(
    ...
    if args.weight_decay is not None and (
        not math.isfinite(args.weight_decay) or args.weight_decay < 0.0
    ):
